...
# -*- coding: utf-8 -*-
#
# Scrumban documentation build configuration file, created by
...
project = 'Scrumban'
copyright = '2016, Tadashi, Carlos, Alex, Uriel'
author = 'Tadashi, Carlos, Alex, Uriel'
...
latex_documents = [
    (master_doc, 'Scrumban.tex', 'Scrumban Documentation',
     'Tadashi, Carlos, Alex, Uriel', 'manual'),
]
...
man_pages = [
    (master_doc, 'scrumban', 'Scrumban Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Scrumban', 'Scrumban Documentation',
     author, 'Scrumban', 'One line description of project.',
     'Miscellaneous'),
]
